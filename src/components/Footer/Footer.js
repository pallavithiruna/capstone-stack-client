...
function Footer() {
  return (
    ...
    {/* <img src="./assets/icon.png" alt="" className="footer-robot-img"/> */}
    ...
    <div className="footer-content">
        ...
        <div className="footer-nav">
            <div className="footer-nav-col">
                ...
                <ul class="footer-links">
                    <li className="footer-link-item"><div className="footer-link">Questions</div></li>
        ...
        {/* <div className="footer-another-links">
            ...
            <div className="copyright">
                <p>site design / logo © 2024 Stack Exchange Inc; user contributions licensed under <a href="https://stackoverflow.com/help/licensing">cc by-sa</a>. rev 2020.10.2.37725</p>
            </div>
        </div> */}
    </div>
</div>
